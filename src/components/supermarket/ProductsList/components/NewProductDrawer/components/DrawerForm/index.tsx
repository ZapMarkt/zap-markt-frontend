    ...
    <>
      ...
      <Tabs defaultValue="details" className="mb-[35px]">
        <TabsList className="flex justify-start items-center w-max py-1 px-[6px] gap-2 h-[46px]">
          <TabsTrigger
            className="data-[state=active]:bg-customMkt-primary px-2 
            py-[10px] text-lg font-medium leading-[18px]"
            value="details"
          >
            Detalhes
          </TabsTrigger>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)}>
            <div className="flex justify-between flex-col">
              <TabsContent value="details" className="mb-5">
                <FormField
              ...
              <TabsContent
                value="prices"
                className="mb-5 h-[calc(100vh-303px)]"
              >
                      ...
                      <FormItem>
                        ...
                        <FormControl className=" space-y-1">
                          <div className="flex items-center gap-4 max-h-[3.5rem] p-3 rounded-[.3125rem] border border-customMkt-gray7 focus-within:border-customMkt-primary focus-within:outline-none focus-within:ring-2 focus-within:ring-customMkt-primary transition-all group space-y-0 mb-0">
                            ...
                            <Switch
                              className={cn(
                                'data-[state=checked]:bg-customMkt-primary data-[state=unchecked]:bg-input',
                                promotion && 'data-[state=checked]',
                              )}
                              checked={promotion}
                              onCheckedChange={() =>
              ...
              <TabsContent value="stock" className="mb-5 h-[calc(100vh-303px)]">
